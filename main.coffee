...
noparse=0"
	...
	DS.historyClick = `(function() {
		...
		function urlHashCheck() {
			var mayChangeReload = false; // _needReload может обнулитьс€ так как urlHashCheck может еще не закончитьс€ а _needReload уже поставили true
...
# https://github.com/mtrpcic/pathjs
	...
	# DS.$el.shop.innerHTML = '<div id="digiseller-preloader">«агрузка...</div>'
	# DS.dom.getStyle(DS.opts.host + 'shop_css.asp?seller_id=?' + DS.opts.seller_id)
