...
(function() {
  ...
  (function(window, document) {
    ...
    DS.widget = {
      ...
      comments: (function() {
        ...
        _Class.prototype.get = function() {
          var that;
          that = this;
          DS.JSONP.get('http://shop.digiseller.ru/xml/shop_reviews.asp', this.$el, {
      ...
      category: {
        ...
        init: function($el) {
          ...
          this.isInited = false;
          that = this;
          DS.JSONP.get('http://shop.digiseller.ru/xml/shop_categories.asp', this.$el, {
            seller_id: DS.opts.seller_id,
            format: 'json'
          }, function(data) {
            if (!data) {
    ...
    DS.init = function() {
      ...
      DS.dom.getStyle(DS.opts.host + '/test/css/default/main.css?seller_id=' + DS.opts.seller_id, function() {
      ...
      DS.dom.addEvent(DS.$el.shop, 'change', function(e) {
        return callback(e, 'change');
      });
    };
    DS.share = {
